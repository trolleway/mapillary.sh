...
mapillary_tools process_and_upload --advanced --import_path "$path/45" --user_name trolleway  \
--interpolate_directions --offset_angle 45  --overwrite_EXIF_direction_tag  --keep_duplicates
